...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Verify CECL Recover Rates page")]
        [NUnit.Framework.CategoryAttribute("CECLRecoveryRates")]
        public virtual void VerifyCECLRecoverRatesPage()
        {
            string[] tagsOfScenario = new string[] {
                    "CECLRecoveryRates"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify CECL Recover Rates page", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 124
 this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
